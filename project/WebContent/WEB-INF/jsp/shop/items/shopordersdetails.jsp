...
<html>
    <head>
        <title>注文一覧</title>
        <%@include file="../../../../css/shopordersdetails.css" %>
    ...
    <br>
        <h1>${shop.shopName}のショップ管理ページ</h1>
	        <div class="cont_nav size1 ">
			    ...
			    <a class="backgra true" href="showshoporders">注文一覧</a>
...
<div class="wrap pattern-3 mhb-20 color">
			...
			<div class="a">
				...
				<div class="b">
				<a>： 　${item.purchaseDate}</a><br>
				<a>： 　${item.orderPrice}円 </a><br>
				<a>： 　${item.userName}</a><br>
 				<div class="left">
 				<a href="showsingleorderdetails?orderId=${item.orderId}" >詳細を見る</a><br>
				</div>
				</div>
				</div>
				</div>
