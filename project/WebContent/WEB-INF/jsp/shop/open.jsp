		...
		<div class="boxwrap">
			<div class="wrap pattern-3 mhb-20">
		        ...
		        <form method="POST" action="addshop">
		            <a class="color">ショップ名</a><input type="text" name="shopName" maxlength="40" required><br>
		           	<a class="color">ショップの紹介文</a><br><textarea  cols="25" rows="8" name="shopExplanation" maxlength="500" ></textarea><br>
		            <a class="color">お礼の一言</a><input type="text" name="shopSellerWord" maxlength="400" ><br>
		            <input type="radio" name="shopIsOpen" value="open" checked><a class="color">公開</a>
		            <input type="radio" name="shopIsOpen" value="close" ><a class="color">非公開</a>
